...
class FoodDetails extends StatefulWidget {
  ...
  final foodName;
  final foodPrice;
   FoodDetails({this.foodName,this.foodPrice,this.heroTag});
...
class _FoodDetailsState extends State<FoodDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          backgroundColor: Color(0xFF6A9BEE),
          appBar: AppBar(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      height: MediaQuery.of(context).size.hashCode-100.0,
                      width: MediaQuery.of(context).size.width,
                    ),
                    ),
                    Positioned(
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        child: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Padding(padding: EdgeInsets.only(top: 8.0,left: 15.0),
